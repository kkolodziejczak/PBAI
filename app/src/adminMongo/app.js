process.env.PORT_MONGO_ADMIN = process.env.PORT_MONGO_ADMIN || 8090
// process.env.MONGO_CONNECTION_STRING = "mongodb://localhost:27017/dev"

if (!process.env.MONGO_CONNECTION_STRING){
    console.error("MONGO_CONNECTION_STRING not set setting default")
	process.env.MONGO_CONNECTION_STRING="mongodb://localhost:27017/dev"
}
...
fs.writeFileSync(config_connections, JSON.stringify({
    "connections": {
      "db": {
...
process.env.PORT = process.env.PORT_MONGO_ADMIN;
